...
public class TwitterClient extends OAuthBaseClient {
	...
	public static final String REST_CONSUMER_KEY = "xyVI3oe2jU8O6KU33gj773aC4";       // Change this
	public static final String REST_CONSUMER_SECRET = "KbfXNwtYfFJFI2HBBdFgbKMlqZHdfnGzOmiDsi6GxDNDXKVt5d"; // Change this
    ...
    public void postReTweet(String text, String uid, AsyncHttpResponseHandler handler) {
        String apiurl = getApiUrl("statuses/update.json");
        RequestParams params = new RequestParams();
        params.put("status", text);
